...
const STRATEGY = [
  ...
  },
  {
    icon: "Zap",
    title: "Алго-трейдинг",
    desc: "Автоматические системы для входа и выхода из позиций на основе исторических паттернов.",
  },
];

const ROADMAP = [
  { q: "Q1 2025", title: "Основание команды", desc: "Формирование ядра команды, тестирование стратегий на исторических данных", done: true },
  { q: "Q2 2025", title: "Запуск торговли", desc: "Начало активной торговли, первые результаты и оптимизация подходов", done: true },
  { q: "Q3 2025", title: "Масштабирование", desc: "Увеличение объёмов торговли, подключение автоматических систем", done: true },
    ...
    <div className="min-h-screen bg-[#080808] font-body text-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 pt-20">
        <div className="absolute inset-0 overflow-hidden">
          <img
            src="https://cdn.poehali.dev/projects/a01245e3-99c5-4748-a289-d3dc6be5337b/files/c671015b-c994-4d08-ad1f-59c4424d2fb0.jpg"
